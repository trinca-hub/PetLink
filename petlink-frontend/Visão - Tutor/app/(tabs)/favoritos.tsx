        ...
        <View style={{ flex: 1, paddingHorizontal: 16, paddingTop: 14 }}>
          {loading ? (
            ...
            <View style={{ paddingTop: 16 }}>
              <Text style={{ color: "#fff", fontWeight: "900" }}>Nenhum favorito por aqui.</Text>
              <Text style={{ color: "rgba(255,255,255,0.75)", marginTop: 6 }}>
                Marque produtos com o coracao para salvar.
              </Text>
            </View>
          ) : (
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  <Text numberOfLines={2} style={{ marginTop: 10, fontWeight: "900", color: "#111" }}>
                    {item.nome}
                  </Text>

                  <View style={{ marginTop: 8, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                    <Text style={{ fontWeight: "900", color: "#0B3B91" }}>
