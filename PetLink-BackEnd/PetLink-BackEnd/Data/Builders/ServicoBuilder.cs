...
namespace PetLink_BackEnd.Data.Builders
{
    public class ServicoBuilder
    {
        public static void Build(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Servico>().Property(p => p.PetId).IsRequired();

            modelBuilder.Entity<Servico>()
                .HasData(new List<Servico>
                {
                    new Servico(1, new DateTime(2025, 10, 15, 00, 28, 32, DateTimeKind.Utc), "Consulta do Joquinha", 1, 100.00f, 1),
                    new Servico(2, new DateTime(2025, 9, 18, 15, 20, 22, DateTimeKind.Utc), "Banho da Macoca", 2, 60.00f, 2),
                    new Servico(3, new DateTime(2025, 6, 27, 10, 47, 02, DateTimeKind.Utc), "Tosa da Penelope", 3, 80.00f, 3)
                });
